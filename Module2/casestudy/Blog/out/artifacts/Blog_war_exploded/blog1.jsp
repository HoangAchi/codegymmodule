    ...
    <nav id="nav-wrap">
        ...
        <div class="row">
            ...
            <ul id="nav" class="nav">
                ...
                <li><a href="blog.jsp">Chu de A</a></li>
                <li><a class="button" href="blog1.jsp">Chu de B</a></li>
                <li><a href="blog2.jsp">Chu de C</a></li>
        ...
        <div id="main" class="eight columns">
            ...
            <article class="entry">
                ...
                <header class="entry-header">
                    ...
                    <h2 class="entry-title">
                        <a href="single.jsp" title="">Bai viet so 1 cua chu de A</a>
                    </h2>
            ...
            <article class="entry">
                ...
                <header class="entry-header">
                    ...
                    <h2 class="entry-title">
                        <a href="single.html" title="">Bai viet so 2 cua chu de A</a>
                    </h2>
            ...
            <article class="entry">
                ...
                <header class="entry-header">
                    ...
                    <h2 class="entry-title">
                        <a href="single.html" title="">Bai viet so 3 cua chu de A</a>
                    </h2>
            ...
            <article class="entry">
                ...
                <header class="entry-header">
                    ...
                    <h2 class="entry-title">
                        <a href="single.html" title="">Bai viet so 4 cua chu de A</a>
                    </h2>
...
<footer>
    ...
    <div class="row">
        ...
        <p class="copyright">&copy; CodeGym - C0419H1 - Team Pro &copy; Copyright 2014 Keep It Simple. &nbsp; Design by <a title="Styleshout" href="http://www.styleshout.com/">Styleshout</a>.</p>
