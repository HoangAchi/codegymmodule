...
public class MyArrayList<E> extends MyAbstractList<E> {
    ...
    @Override /** Move the elements to the right after the specified index*/
    ...
    @Override/*Remove the element at the specified position * in this list. Shift any subsequent elements
    to the left. * return the element that was removed form the list. */
